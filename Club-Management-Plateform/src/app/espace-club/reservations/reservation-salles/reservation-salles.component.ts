...
@Component({
  selector: 'app-reservation-salles',
  templateUrl: './reservation-salles.component.html',
  styleUrls: ['./reservation-salles.component.css']
})
export class ReservationSalleComponent implements OnInit {
  ...
  initForm(): void {
    ...
    this.reservationForm = this.formBuilder.group({
      ...
      selectedSalleId: ['', Validators.required],
    });
    ...
    return new Promise((resolve) => {
      ...
      for (let i = 0; i < this.reservations.length; i++) {
        ...
        if (
          ...
          reservation.reference === this.reservationForm.get('selectedSalleId')!.value
        ) {
  ...
  createReservation(): void {
    ...
    const newReservation: Reservation = {
      ...
      reference: this.reservationForm.value.selectedSalleId,
      onModel: 'Salle',
